  ...
  return (
    <>
      <div className="bg-[url('/img/bg-colors.webp')]  bg-cover w-full h-full relative">
        ...
        <svg className="absolute w-[50%] h-[50%] left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%]" width="2490" height="1501" viewBox="0 0 2490 1501" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g opacity="0.02">
        ...
        <div className="absolute flex gap-[1vw] left-[9vw] top-[1.5%] text-[.8em] font-medium text-blue h-[1.2em]">
          ...
          <div className="flex gap-[.2vw]">
            <svg className="h-full w-auto inline-block" width="81" height="39" viewBox="0 0 81 39" fill="none" xmlns="http://www.w3.org/2000/svg">
